# mypersonal
The program collects personal details from the user, validates input, performs a small calculation, and displays the information in a clean, formatted way.
